...
| Harness CI | [[50_deepdives/harness-company/90_report#5.3 Pipeline：概率决策与确定性执行的混合图|Harness Pipeline 混合控制机制]] | [[20_summaries/companies/README#4. Harness：从 Pipeline 平台到 Agent 控制面|Harness 公司总结]] | [[00_sources/briefs/2026-harness-worker-agents]]、[[00_sources/briefs/2026-harness-worker-agent-security]]、[[00_sources/briefs/2026-harness-code-quality-agents]]、[[00_sources/briefs/2026-harness-ai-devops-agent]] | `mapped` |
