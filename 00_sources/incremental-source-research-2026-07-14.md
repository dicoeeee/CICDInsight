...
> [!abstract] 本轮范围
> 这是相对原有 67 条来源完成的增量研究。时间窗为 2025-07-01 至 2026-07-14，优先 2026 年一手资料。本页保留当时 25 条增量候选的排重、差异与选源依据；经过 [[00_sources/source-pruning-2026-07-14|核心信息源精简]]形成 80 条基线，后续补充的通用 Agent Harness 资料重新编号为 S78—S80，并于同日增补 S81 CLI-Anything。当前主登记为 81 条，本页是研究过程记录，不代表最终核心来源数量。
