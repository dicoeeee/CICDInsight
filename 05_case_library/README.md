...
> [!summary] 定位
> 本目录保存可跨专题复用的外部实践案例。案例卡从 [[00_sources/README|L0 信息源与 Source Brief]]提取事实，但不复制完整 Brief；它重点回答“谁在什么场景中，用什么架构和控制边界做了什么，以及能证明到什么程度”。
...
4. 新事实先更新 Source Brief，再更新案例卡和专题报告。
5. 案例进入主报告前，必须在专题的 Claim—Evidence Matrix 中说明支撑哪个论点。
